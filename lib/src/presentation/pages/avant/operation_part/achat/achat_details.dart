...
class AchatDetails extends StatefulWidget {
  ...
  const AchatDetails({super.key, required this.transaction});
        ...
        child: Padding(
          ...
          child: TransactionDetailsWidgets().detailPart(
                ...
                relancerAction:() async {
                 // await  TransactionApi().loadAgainWaitingTransaction(context,"achat",widget.transaction);
                },
              ),
        ),
      ),
