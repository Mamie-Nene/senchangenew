...
import 'package:senchange/Src/utils/consts/constants.dart';
...
class BuyOrSellPage extends StatefulWidget {
  const BuyOrSellPage ({super.key});

  @override
  State<BuyOrSellPage > createState() => _BuyOrSellPageState();
}
      ...
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              Text(isAchat?AppText.VENDRE_TITLE_TEXT:AppText.ACHAT_TITLE_TEXT,
                  ...
                  Expanded(
                    child: AppUtilsWidget().transactionTypeCard(
                      ...
                      onTap: () {
                        ...
                        Navigator.of(context).pushReplacementNamed(AppRoutesName.acheterPage);
                      } ,
                    ),
                  ),
                  Expanded(
                    child: AppUtilsWidget().transactionTypeCard(
                      ...
                      onTap: () {
                        ...
                        Navigator.of(context).pushReplacementNamed(AppRoutesName.vendrePage);
                      },
              ...
              amountField(
                hint: "0",
                label: isAchat?"Montant en CFA":'Montant en USDT',
                suffix: "CFA",
                highlighted: false,
                ...
                onTap: (){
                  setState(() {
                    montantUSDT.text = montantCFA.text * tauxAchat.toInt();
                  });
                }
              ),
              ...
              Center(
                child: TextButton.icon(
                  ...
                  onPressed: () {
                    setState(() {
                    final tempCFA = montantCFA.text;
                    final tempUSDT = montantUSDT.text;
                    montantCFA.text = tempUSDT;
                    montantUSDT.text = tempCFA;
                  });},
